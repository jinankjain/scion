...
\title{APNA in SCION} %% that will be typeset on the
\subtitle{Accountable and Private Network Architecture} %% title page.
\author{Jinank Jain, Taeho Lee}
...
\begin{document}
  ...
  \begin{darkframes}
    \section{What is APNA?}
    \begin{frame}{APNA}
      \framesubtitle{Accountable and Private Network Architecture}%
      \begin{block}{Source Accountability}
        This is a plain block containing some \alert{highlighted text}.
      \end{block}
      \begin{alertblock}{Privacy Preserving}

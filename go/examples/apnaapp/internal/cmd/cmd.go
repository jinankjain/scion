...
import (
	...
	"github.com/scionproto/scion/go/examples/apnaapp/internal/client"
	"github.com/scionproto/scion/go/examples/apnaapp/internal/config"
	"github.com/scionproto/scion/go/examples/apnaapp/internal/ephidbenchmark"
	"github.com/scionproto/scion/go/examples/apnaapp/internal/server"
)

...
cmd_run_apna_pcslabserver() {
    echo "Running apna server"
    ./bin/apna_app -a go/examples/apna_app/testdata/server_slab.json -l 20-ffaa:1:d4,[127.0.0.1]:50049 server
}

cmd_run_apna_slabclient1() {
    echo "Running apna client"
    ./bin/apna_app -a go/examples/apna_app/testdata/client_slab.json -r 19-ffaa:1:d3,[127.0.0.1]:50049 -l 20-ffaa:1:d4,[127.0.0.4]:50045 client
}

cmd_run_apna_slabclient2() {
    echo "Running apna client"
    ./bin/apna_app -a go/examples/apna_app/testdata/client_slab.json -r 17-ffaa:1:d5,[127.0.0.1]:50049 -l 20-ffaa:1:d4,[127.0.0.4]:50045 client
}
